...
alias lg='lazygit'
alias ll='eza -la --icons --group-directories-first -s type'
alias ls='eza -a --icons --group-directories-first -s type'
...
alias rec='wl-screenrec --low-power=off --bitrate="40 MB" --codec=hevc'
